...
class TestPlace(unittest.TestCase):
    """Defines a test unit for the Place
    Functions:
    ...
    def setUpClass(cls):
        ...
        cls.obj_id_pat = re.compile(
                r'Place\.[\da-f]{8}(\-[\da-f]{4}){3}\-[\da-f]{12}')
        cls.obj = Place()
        cls.obj1 = Place()
        cls.obj1.city_id = "12314"
        cls.obj1.name = "FORTRESS OF SOLITUDE"
        cls.obj1.number_rooms = 3
        cls.obj1.latitudes = 32.7
        cls.obj1.amenity_ids = ["1234", "353556", "46768", "658696"]
        cls.obj1.type = "appartment"
        cls.obj1.city = "Cotonou"
        cls.obj1.room = 3
        cls.obj1.area = 70
        cls.obj1.save()
        cls.obj2 = Place(**cls.obj1.to_dict())
    ...
    def test_1_init_new(self):
        ...
        self.assertEqual(0.0, self.obj2.latitude)
    ...
    def test_2_init_kwargs(self):
        ...
        self.assertEqual("", self.obj2.__class__.city_id)
        self.assertEqual("", self.obj2.__class__.name)
        self.assertEqual(0, self.obj2.__class__.number_rooms)
        self.assertEqual(0.0, self.obj2.__class__.latitude)
        self.assertEqual([], self.obj2.__class__.amenity_ids)
    ...
    def test_5_to_dict(self):
        ...
        """
        self.assertEqual(13, len(self.obj1.to_dict()))
        ...
        self.assertEqual(13, len(self.obj2.to_dict()))
