...
class TestCity(unittest.TestCase):
    """Defines a test unit for the City
    Functions:
    ...
    def setUpClass(cls):
        ...
        cls.obj_id_pat = re.compile(
                r'City\.[\da-f]{8}(\-[\da-f]{4}){3}\-[\da-f]{12}')
        cls.obj = City()
        cls.obj1 = City()
        cls.obj1.state_id = "123456"
        cls.obj1.name = "Luthor"
    ...
    def test_2_init_kwargs(self):
        ...
        self.assertEqual("", self.obj2.__class__.state_id)
    ...
    def test_5_to_dict(self):
        ...
        """
        self.assertEqual(10, len(self.obj1.to_dict()))
        ...
        self.assertEqual(10, len(self.obj2.to_dict()))
